        ...
        >
          ...
          >
            ...
            <div className="relative flex-shrink-0" style={{ height: '42vh' }}>
              <MobileImage car={car} loaded={loaded} setLoaded={setLoaded} onClose={onClose} />
            </div>
            {/* Mobile content */}
            <div className="flex-1 overflow-y-auto">
              <PanelContent car={car} mainSpecs={mainSpecs} detailSpecs={detailSpecs} onClose={onClose} />
            </div>
          </motion.div>
...
{!loaded && <div className="absolute inset-0 bg-[#111] animate-pulse z-10" />}
            ...
            <div className="flex-1 overflow-y-auto relative">
              <PanelContent car={car} mainSpecs={mainSpecs} detailSpecs={detailSpecs} onClose={onClose} desktop />
            </div>
          </motion.div>
        </motion.div>
      )}
...
function PanelContent({ car, mainSpecs, detailSpecs, onClose, desktop }) {
  return (
    <motion.div
